        ...
        <body>
            <header class="header-content header">
                <div class="logo-content">
                    <router-link to="/addemployee"> <img src="../assets/assets/Images/logo.png" alt="" /></router-link>
                    <div>
...
.emp-details-text {
    margin-right: 70%;
    font-family: Roboto;
    font: normal normal bold italic 24px/25px Roboto;
    letter-spacing: 0px;
    color: #42515f;
    opacity: 1;
}
...
.tr {
    background: #1b2630 0% 0% no-repeat padding-box;
}
